import flwr as fl
from flwr_clients import LUSClient
...
#initializing the model named as net 
net = resnet18_cbam()
...
class SaveModelStrategy(fl.server.strategy.FedAvg):
    ...
    def aggregate_fit(
        ...
        if aggregated_parameters is not None:
            ...
            # Save the model
            torch.save(net.state_dict(), '/projectnb/ivcgroup/ukhan3/FL/FedAvg_450/' + f"model_round_{server_round}.pth")
